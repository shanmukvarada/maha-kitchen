  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === 'auth/invalid-credential' || error.code === 'auth/user-not-found') {
        toast.error('Invalid email or password. If this is your first time, please Sign Up.');
      } else {
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            className="mt-4 w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-lg transition-colors flex justify-center items-center gap-2"
          >
            ...
            <form onSubmit={handleForgotPassword}>
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-lg transition-colors flex items-center disabled:opacity-50"
                >
